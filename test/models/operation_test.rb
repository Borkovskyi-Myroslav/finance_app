...
class OperationTest < ActiveSupport::TestCase
  ...
  # test "destroy 'Category.id' nil " do
  #   oper_destroy = Operation.delete_by(category_id: Category.second.id)
  #   #puts oper_destroy.description
  #   assert_not(oper_destroy.description.valid?)
  # end
